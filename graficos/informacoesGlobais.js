...
async function  visualizarDadosGlobais(){
    ...
    <span> ${totalPessoasMundo} de habitantes e destes </span> ${totalPessoasConectadas} </span> estão conectadas a alguma rede social e ficam em média <span> ${tempoMedio} </span>conectados.`
